...
export default function ProfileForm({
  ...
  const [showPhoneAfterAccept, setShowPhoneAfterAccept] = useState(initialShowPhoneAfterAccept);
  const [showWhatsappAfterAccept, setShowWhatsappAfterAccept] = useState(initialShowWhatsappAfterAccept);
    ...
    if (workerEnabled) {
      if (existingWorker?.id) {
        ...
        if (workerUpdateError) {
          setLoading(false);
          alert(workerUpdateError.message);
          return;
        }
      }
    } else {
      if (existingWorker?.id) {
        ...
        if (workerDisableError) {
          setLoading(false);
          alert(workerDisableError.message);
          return;
        }
      }
    }
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm">
          ...
          <div className="mt-6 grid gap-5 sm:grid-cols-2">
            ...
            <label className="flex items-center justify-between rounded-2xl border border-slate-200 bg-slate-50 p-4">
              <div>
                <p className="font-semibold text-slate-900">Show phone after acceptance</p>
            ...
            <label className="flex items-center justify-between rounded-2xl border border-slate-200 bg-slate-50 p-4">
              <div>
                <p className="font-semibold text-slate-900">Show WhatsApp after acceptance</p>
                <p className="mt-1 text-sm text-slate-600">
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm">
          ...
          <p className="mt-3 text-sm leading-6 text-slate-600">
            Save your information to keep your local results, account roles, availability, and direct contact settings up to date.
          </p>
